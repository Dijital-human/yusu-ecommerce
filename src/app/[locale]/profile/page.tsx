  ...
  return (
    <Layout>
      <div className="container mx-auto py-8 px-4">
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <div className="flex items-center p-3 bg-gray-50 rounded-md">
                  ...
                  <span className="text-gray-900">{session.user?.name || tCommon("notProvided")}</span>
                </div>
              )}
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <div className="flex items-center p-3 bg-gray-50 rounded-md">
                  ...
                  <span className="text-gray-900">{(session.user as any)?.phone || tCommon("notProvided")}</span>
                </div>
              )}
            </div>
        ...
        {/* Addresses Section / Ünvanlar Bölməsi */}
        <Card className="mt-6">
          <CardHeader>
          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              >
                ...
                <span className="text-sm">{t("viewOrders")}</span>
              </Button>
              ...
              {session.user?.role === "SELLER" && (
                ...
                >
                  <Package className="h-6 w-6 mb-2" />
                  <span className="text-sm">{t("sellerPanel")}</span>
                </Button>
              )}
              ...
              {session.user?.role === "COURIER" && (
                ...
                >
                  ...
                  <span className="text-sm">{t("courierPanel")}</span>
                </Button>
              )}
            </div>
          </CardContent>
